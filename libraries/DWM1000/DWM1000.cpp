...
} txPowerSmart[] = { { 0, 0x00, 0x00 }, { 1, 0x15355575, 0x07274767 }, { 2,
		0x15355575, 0x07274767 }, { 3, 0x0F2F4F6F, 0x2B4B6B8B }, { 4,
		0x1F1F3F5F, 0x3A5A7A9A }, { 5, 0x0E082848, 0x25456585 },
